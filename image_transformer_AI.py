...
prompt = """Suggest some changes about the image for editing, tell on what scale I should keep the brightness, contrast, sharpness, color, from a scale of 1.00 to 2.00 each and about the pixel adjustment factor with which this image pixels can be multiplied with a number from a range of 1.00 to 10.00, so as to enhance the picture quality, just write some points about those values and also about the image, like 2-3 lines """
...
def image_prompter(photo, prompt):
    try:
        ...
        output = """What you asked might be unethical or inappropriate"""
    finally:
